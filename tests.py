...
class TestBooksCollector:
    ...
    def test_add_new_book_len_more_then_40_false(self):
        collector = BooksCollector()
    ...
    def test_set_book_genre_if_book_in_books_genre_and_her_genre_in_genre_true(self):
        collector = BooksCollector()
        name = '12 стульев'
        genre = 'Комедии'
        collector.add_new_book(name)
    ...
    def test_test_set_book_genre_if_book_in_books_genre_and_her_genre_not_in_genre_true(self):
        collector = BooksCollector()
        name = '12 стульев'
        genre = 'Мелодрама'
        collector.add_new_book(name)
